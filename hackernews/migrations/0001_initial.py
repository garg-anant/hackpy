    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('num_comments', models.PositiveIntegerField(blank=True, default=0, null=True)),
                ('hackernews_post_id', models.PositiveIntegerField(unique=True)),
                ('karma_points', models.CharField(blank=True, max_length=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='hackernews.comments')),
